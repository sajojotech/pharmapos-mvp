    ...
    <div className="flex flex-col gap-4">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-600">
          20 produk dengan qty terjual terbanyak dalam rentang tanggal yang
          dipilih.
        </p>
      </div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        />
        <ReportExportLink basePath="/reports/top-products" filters={{ branchId, categoryId, dateFrom, dateTo }} />
      </div>
