...
import { AdjustmentForm, type BatchOption } from "./adjustment-form";
...
export default async function NewAdjustmentPage() {
  ...
  if (!context.activeBranchId || !context.activeBranch) {
    return (
      <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800">
        ...
        adjustment. Pilih cabang di header atau hubungi Admin Pusat.
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        <h1 className="text-2xl font-bold text-slate-900">Buat Stock Adjustment</h1>
        <p className="mt-1 text-sm text-slate-600">
          Hanya batch berstatus Tersedia (qty {">"} 0) yang bisa dipilih.
